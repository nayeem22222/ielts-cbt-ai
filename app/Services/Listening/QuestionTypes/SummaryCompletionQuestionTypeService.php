...
class SummaryCompletionQuestionTypeService extends BaseListeningQuestionTypeService
{
    use HandlesCompletionQuestionType;

    public function type(): ListeningQuestionType
    {
        return ListeningQuestionType::SummaryCompletion;
    }
    ...
    {
        return ['content' => ['required', 'string'], 'settings.word_limit' => ['required', 'integer']];
    }
    ...
    public function validatePayload(
        ...
        if ($question === null) {
            ...
            $errors = $group ? $this->validateCompletionContent($content, $group) : [];
