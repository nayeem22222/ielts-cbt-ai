...
class StoreListeningQuestionGroupRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $section = $this->route('section');
        $start = (int) $this->input('start_question_number', 0);
        ...
        return [
            ...
            'end_question_number' => ['required', 'integer', 'min:1', 'max:40', 'gte:start_question_number', new ValidListeningQuestionRange($section, $start)],
