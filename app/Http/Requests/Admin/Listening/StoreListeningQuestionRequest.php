...
class StoreListeningQuestionRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        return $group !== null && ($this->user()?->can('create', [ListeningQuestion::class, $group]) ?? false);
    }
    ...
    public function rules(): array
    {
        ...
        return [
            'question_number' => ['required', 'integer', 'min:1', 'max:40', new ValidListeningQuestionNumber($test, $section, $group)],
