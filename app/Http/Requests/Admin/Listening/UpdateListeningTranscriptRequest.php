...
class UpdateListeningTranscriptRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return $transcript !== null && ($this->user()?->can('update', $transcript) ?? false);
    }
    ...
    public function rules(): array
    {
        ...
        $transcript = $this->route('transcript');
        $audioId = $this->input('listening_audio_id') !== null
            ? (int) $this->input('listening_audio_id')
