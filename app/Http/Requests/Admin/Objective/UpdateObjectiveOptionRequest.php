...
class UpdateObjectiveOptionRequest extends ObjectiveScopedRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'option_label' => ['sometimes', 'required', 'string', 'max:5000'],
    ...
    public function optionAttributes(): array
    {
        return array_filter([
            ...
            'option_label' => $this->has('option_label') ? $this->string('option_label')->toString() : null,
    ...
    {
        return $this->optionFromRoute()?->question?->group;
    }
}
