...
@if ($interactionMode === ReadingGroupInteraction::MODE_DRAG_DROP)
    <div
        class="reading-dnd-group reading-test-matching-features-dnd space-y-4"
        data-group-id="{{ $group->id }}"
        data-dnd-type="matching_features"
...
@else
    <div class="reading-test-matching-features grid gap-6 lg:grid-cols-2">
        <div>
            <h4 class="reading-test-subheading">Options</h4>
