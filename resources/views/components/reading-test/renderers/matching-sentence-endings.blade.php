...
@if ($interactionMode === ReadingGroupInteraction::MODE_DRAG_DROP)
    <div
        class="reading-dnd-group reading-test-matching-endings-dnd grid gap-6 lg:grid-cols-2"
        data-group-id="{{ $group->id }}"
        data-dnd-type="matching_sentence_endings"
