...
$variants=[
 ...
 'secondary'=>'bg-neutral-800 !text-white hover:bg-neutral-700 dark:bg-neutral-200 dark:!text-neutral-900 dark:hover:bg-white',
 'outline'=>'border border-neutral-200 bg-white !text-neutral-800 hover:border-brand-200 hover:bg-brand-50 dark:border-neutral-700 dark:bg-neutral-900 dark:!text-neutral-100 dark:hover:bg-neutral-800',
