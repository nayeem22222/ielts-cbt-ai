<x-layouts.listening-exam :title="$test->title.' — Results'" scrollable>
    ...
    <div class="reading-test-shell mx-auto max-w-6xl px-4 py-10 pb-16">
        <div class="mb-8 text-center">
            <p class="text-xs font-semibold uppercase tracking-wide text-brand-600">Listening Test Results</p>
        ...
        <div class="grid gap-6 lg:grid-cols-[220px_1fr]">
                ...
                <div class="rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm">
                    ...
                    <div class="flex flex-wrap gap-1.5">
                        @foreach ($question_map as $item)
                            <a
                                href="{{ route('student.listening.attempts.result.review', $attempt) }}#question-{{ $item['question_number'] }}"
            ...
            <div class="order-1 space-y-8 lg:order-2">
                ...
                @if (! empty($insights))
                    <section class="rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm">
                        <h2 class="text-lg font-semibold text-neutral-900">Listening Insights — Weak Areas</h2>
                ...
                <div class="flex flex-wrap justify-center gap-3">
                    <a href="{{ route('student.listening.attempts.result.review', $attempt) }}"
                       class="rounded-lg bg-brand-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-brand-700">
                        Question Review
                    </a>
                    <a href="{{ route('student.listening.tests.index') }}"
