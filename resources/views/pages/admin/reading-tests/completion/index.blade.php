...
>
    ...
    <div
        ...
        x-init="init()"
    >
        @include('pages.admin.reading-tests.completion.partials.header', ['type' => $type])

        <div class="mb-4 flex flex-wrap gap-2">
            <x-ui.button href="{{ route('admin.reading-question-groups.completion-questions.index', $group) }}">Edit Builder</x-ui.button>
            <x-ui.button href="{{ route('admin.reading-question-groups.completion-questions.index', ['group' => $group, 'preview' => 1]) }}" variant="outline">Preview</x-ui.button>
